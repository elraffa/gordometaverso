    ...
    <div>
      <div className="main">
        ...
        <div className='main__text'>
          ...
          <p className='main__par'>
            Lleva 9 temporadas consecutivas en Plaza Serrano donde varias veces algunos espectadores quisieron golpearlo varias veces.</p>
          <p className='main__par'>
            Como actor jamás quedo en ningún casting. Su fuerte es la falta de registro y la carencia de autocrítica, que hicieron que hoy, esté pasando un mal momento económico.</p>
          <p className='main__par'>
